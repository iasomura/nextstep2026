...
## 検証済み数値リファレンス（2026-02-07 SO再評価後）

> 以下は `artifacts/2026-02-02_224105/results/` 配下のCSVから直接計算した権威的な数値である。
> 論文執筆時はこの数値を使用すること。
>
> 2026-02-07: SO (Structured Output) parse failure 16件中15件を再評価して修復済み。
> 残り1件 (hamidi.sa.com) はTPのため判定結果に影響なし。table6アブレーションのみ n=11,951。
