...
URL・ドメイン特徴量によるML検出は広く研究されている。Aljofey et al. [1] はURL・HTML・証明書のハイブリッド特徴量をXGBoostで分類しF1=96.38%を報告した。証明書特徴量に特化した研究として、Haraldsdottir et al. [2] はPhishTank+TrancoデータをCensysで証明書取得し、証明書のみF1=0.77、ドメイン名追加でF1=0.89を達成している。Kumar et al. [3] はTLS 1.2/1.3トラフィックから復号不要で特徴抽出するアプローチを提案した。
...
[2] M. Haraldsdottir, S. Homayoun, E. Lynge, and C. D. Jensen, "Unmasking phishers: ML for malicious certificate detection," *Computers & Industrial Engineering*, vol. 198, pp. 110652, 2024. DOI: 10.1016/j.cie.2024.110652

[3] M. Kumar, C. Kondaiah, A. R. Pais, and R. S. Rao, "Machine learning models for phishing detection from TLS traffic," *Cluster Computing*, vol. 26, no. 5, pp. 3263–3277, 2023. DOI: 10.1007/s10586-023-04042-6
